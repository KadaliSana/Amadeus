...
export class LAppDelegate {
  ...
  private onPointerBegan(e: PointerEvent): void {
    const avatar= document.getElementById("avatar-area");
  ...
  private releaseEventListener(): void {
    ...
    const avatar= document.getElementById("avatar-area");
    avatar.removeEventListener('pointerup', this.pointBeganEventListener);
    this.pointBeganEventListener = null;
    avatar.removeEventListener('pointermove', this.pointMovedEventListener);
    this.pointMovedEventListener = null;
    avatar.removeEventListener('pointerdown', this.pointEndedEventListener);
    this.pointEndedEventListener = null;
    avatar.removeEventListener('pointerdown', this.pointCancelEventListener);
  ...
  private initializeEventListener(): void {
    ...
    // ポインタ関連コールバック関数登録
    avatar.addEventListener('pointerdown', this.pointBeganEventListener, {
      passive: true
    });
    avatar.addEventListener('pointermove', this.pointMovedEventListener, {
      passive: true
    });
    avatar.addEventListener('pointerup', this.pointEndedEventListener, {
      passive: true
    });
    avatar.addEventListener('pointercancel', this.pointCancelEventListener, {
      passive: true
    });
  }
